...
while not ready:
  ...
  try:
    lat1, lon1, lat2, lon2 = input('Enter latitud_1, longitude_1, latitud_2, longitude_2 for your search. Eg. 45 -100 32 -120: ').split()
    lat1 = float(lat1)
    lon1 = float(lon1)
    lat2 = float(lat2)
    lon2 = float(lon2)
    ...
    print('Make sure you entry are 4 floats.')
